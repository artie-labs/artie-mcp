...
`connector_create` is not on the credential allowlist. Creating a saved connector would put production secrets on the agent path; configure connectors in the Dashboard.
